...
export default function CreatorCard(props) {
    return (
        <CreatorCardStyled>
            <ImgCreator src={props.img}/>
            <DivCreatorH1>
                <h3>{props.nickname}</h3>
                <ButtonCreatorLogo><svg width="45" height="45" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.728 8.62207C11.8303 7.79187 12.5444 6.47278 12.5444 4.98981C12.5444 2.48401 10.5057 0.445312
                        ...
                        8.62207C2.32013 9.72986 0.213867 12.5804 0.213867 15.9141H1.62012C1.62012 12.3962 4.48206 9.53448 7.99988
                         ...
                         8.62207ZM4.86145 4.98981C4.86145 3.25928 6.26917 1.85156 7.9997 1.85156C9.73023 1.85156 11.1379 3.25928
                          ...
                          4.98981Z" fill="white"/>
                </svg></ButtonCreatorLogo>
            </DivCreatorH1>
            <DivCreatorH4>
                <h4>{props.amount} LUNA created</h4>
            </DivCreatorH4>
        </CreatorCardStyled>
    )
}
